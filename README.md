...
1. Sign up for an [IBM Cloud account](https://console.ng.bluemix.net/registration/)
...
## Steps
1. Create an instance of the [Watson Assistant](#3.-Create-an-instance-of-the-Watson-Assistant)
2. Create an instance of the [Watson Discovery](#3.-Create-an-instance-of-the-Watson-Discovery)
3. Integrate Watson Assistant and Watson Discovery
4. Cloud Function Set Up


## 3. Create an instance of Watson Assistant
